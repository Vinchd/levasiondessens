...
export default function page() {
	return (
				...
				<div className="flex flex-col items-center leading-4">
					<p>
						...
						<a
							...
							className="text-primary hover:text-[#c5a58c]"
						>
							06 36 18 05 61
						</a>
					</p>
		...
		// <div className="flex justify-center bg-secondary max-md:pt-[90px] w-full h-[calc(100vh-8rem)] text-sm grow">
		// 	<div className="flex flex-col gap-5 my-auto max-md:px-4 w-full max-w-[900px] overflow-y-auto">
		// 		<div className="text-center tracking-wider">
		// 			Une question ? Besoin d’un conseil ou d’une information sur nos
		// 			prestations ? Laissez-nous un message, nous vous répondrons avec
		// 			plaisir dans les plus brefs délais. <br />
		// 			Vous pouvez rapidement et simplement prendre rendez-vous sur&nbsp;
		// 			<a
		// 				href="https://www.planity.com/levasion-des-sens-44760-la-bernerie-en-retz"
		// 				target="_blank"
		// 				rel="noopener noreferrer"
